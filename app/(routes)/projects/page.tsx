      ...
      <div className="container mx-auto px-4 pt-6 pb-12 md:px-6 md:pt-12 md:pb-24">
        ...
        >
          <div className="mb-6 flex flex-wrap justify-center gap-2">
            ...
            {activeFilters.length > 0 && (
              <Badge
                className="cursor-pointer bg-red-100 px-3 py-2 text-sm text-red-600 hover:bg-red-200"
                onClick={() => setActiveFilters([])}
              >
                Clear
              </Badge>
        ...
        {filteredProjects.length === 0 && (
          <div className="py-12 text-center">
            <p className="text-muted-foreground">
              No projects found with the selected technologies. Try another combination.
            </p>
          </div>
        )}
      </div>
